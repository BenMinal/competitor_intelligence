...
Keep insights actionable and business-focused. Use bullet points for clarity."""
    ...
    def generate_pdf_report(analysis_result, competitor_name, video_url, total_comments):
        ...
        try:
            ...
            # Analysis content (simplified for serverless)
            story.append(Paragraph("Competitive Intelligence Analysis", styles['Heading2']))
            story.append(Paragraph(analysis_result, styles['Normal']))
    ...
    def export_pdf():
        try:
            ...
            if not pdf_buffer:
                return jsonify({'error': 'Failed to generate PDF'})
